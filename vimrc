" contents of this file is loaded BEFORE all the plugins

source ~/.vim/bundles.vim          " NeoBundle plugins list
...
source ~/.vim/before.vim           " local configs after all other configs and BEFORE plugins are loaded
